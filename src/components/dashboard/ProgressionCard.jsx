...
export default function ProgressionCard({ xp, level, xpInLevel, xpProgress }) {
  return (
    <Card>
      <div className="text-sm font-bold text-ink mb-2">🎮 PROGRESSION</div>
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="text-base font-bold text-ink">Niveau {level}</div>
          <div className="text-[13px] text-ink-muted mb-1">{xpInLevel} / {XP_PER_LEVEL} XP</div>
      ...
      <div className="text-[12px] text-ink-muted mt-2">{xp} XP total • +10/habitude • +25/étape • +50/focus • +100/journal</div>
    </Card>
  );
}
